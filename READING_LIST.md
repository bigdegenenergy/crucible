...
Books queued for Crucible research. Once research begins on a book, create its folder using the naming convention `{book-title-slug}_{author-last-name}` and follow the [6-phase workflow](CRUCIBLE_WORKFLOW.md).

---

## Foundational / Fill in the Gaps
...
### 11. Models of the Mind: How Physics, Engineering and Mathematics Have Shaped Our Understanding of the Brain
...
- No status = Queued for research
- `[IN PROGRESS]` = Currently being researched
- `[COMPLETE]` = Research complete, see book folder
